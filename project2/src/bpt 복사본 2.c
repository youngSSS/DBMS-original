...
node * delete_entry( node * root, node * n, int key, void * pointer ) {
    ...
    /* k_prime is key value between neighbor node pointer and my pointer in parent node */
    k_prime = n->parent->keys[k_prime_index];
    /* neighbor is right side pointer of me in parent node when neighbor is not exist
     * neighbor is left side pointer of me in parent node when neighbor is exist
     */
